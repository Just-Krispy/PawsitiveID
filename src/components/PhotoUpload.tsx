    ...
    <div className="w-full max-w-lg mx-auto">
      {!preview ? (
        <div
          ...
          role="button"
          tabIndex={0}
          aria-label="Upload a photo of the dog. Click or drag and drop an image."
          onDragOver={(e) => {
            e.preventDefault();
            setDragOver(true);
          }}
        ...
        >
          <div className="mb-4">
            <svg className="mx-auto w-16 h-16" style={{ color: "var(--paw-orange)" }} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
          </div>
          <p className="text-xl font-semibold mb-2" style={{ color: "var(--paw-orange)" }}>
        ...
        <div className="relative rounded-2xl overflow-hidden" style={{ border: "1px solid var(--border-card)" }}>
          <img
            src={preview}
            alt="Uploaded dog photo ready for analysis"
